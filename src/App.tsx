  ...
  if (submitted) return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="bg-white rounded-2xl shadow-md p-10 max-w-md w-full text-center">
        ...
        <p className="text-gray-500 mb-1">Your incident has been successfully submitted.</p>
        <p className="text-gray-500 mb-6">The EHS team has been notified.</p>
        <div className="bg-gray-50 rounded-xl p-4 text-left text-sm text-gray-600 mb-6 space-y-1">
          ...
          <p>
            ...
            <span className={`inline-block px-2 py-0.5 rounded-full text-xs font-semibold border ${severityColors[form.severity as Severity]}`}>
              {form.severity}
            </span>
          </p>
        </div>
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-1">
            ...
            <span className="text-sm font-medium text-green-700 uppercase tracking-wide">EHS Portal</span>
          </div>
          <h1 className="text-3xl font-bold text-gray-900">Report an Incident</h1>
          <p className="text-gray-500 mt-1">All fields marked <span className="text-red-500">*</span> are required.</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6">
          ...
          <div>
            ...
            <select value={form.incidentType}
              ...
              {["Near Miss", "Injury", "Property Damage", "Environmental Spill", "Unsafe Condition"].map(t =>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              {(["Low", "Medium", "High", "Critical"] as Severity[]).map(s => (
                <label key={s} className={`flex items-center justify-center gap-2 border-2 rounded-xl py-2.5
            ...
            <p className="text-xs text-gray-400 mt-1">
              Critical = immediate danger to life or environment. Select carefully.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex justify-between mt-1">
              {errors.description
                ...
                : <span />}
              <p className={`text-xs ${form.description.length < 20 ? "text-gray-400" : "text-green-600"}`}>
